# Building Mi Bóveda for iOS

## Requirements and Setup

The following are the system requirements to build Mi Bóveda for your iOS device.
...
[âœ“] Flutter (Channel stable, 3.27.4, on macOS 15.x.x)
