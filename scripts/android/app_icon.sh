...
MONERO_COM_PATH=$ASSETS_DIR/images/mi-boveda_android_icon.png
MONEROCOM_ICON_SET_PATH=$ASSETS_DIR/images/monerocom_android_icon
CAKEWALLET_PATH=$ASSETS_DIR/images/miboveda_android_icon.png
CAKEWALLET_ICON_SET_PATH=$ASSETS_DIR/images/miboveda_android_icon
ANDROID_ICON=""
...
case $APP_ANDROID_TYPE in
	"mi-boveda")
		APP_LOGO=$ASSETS_DIR/images/mi-boveda_logo.png
		ANDROID_ICON=$MONERO_COM_PATH
		ANDROID_ICON_SET=$MONEROCOM_ICON_SET_PATH
	;;
	"miboveda")
    	APP_LOGO=$ASSETS_DIR/images/miboveda_logo.png
...
if [[ $GITHUB_HUH == "yeah" ]]; then
	pwd
	for file in $(find $CAKE_ROOT/android/app/src/main/res -name "*.png") $APP_LOGO $CAKEWALLET_PATH $ASSETS_DIR/images/miboveda_logo.png $ASSETS_DIR/images/miboveda_icon_*.png $(find $CAKEWALLET_ICON_SET_PATH -name "*.png"); do
