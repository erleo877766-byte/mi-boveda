...
LABEL org.opencontainers.image.source=https://github.com/ourwallet/our_wallet
...
RUN git config --global user.email "ci@ourwallet.com" \
    && git config --global user.name "OurWallet CI" \
