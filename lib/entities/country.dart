...
class Country extends EnumerableItem<String> with Serializable<String> {
  ...
  static List<Country> get allCountries => _all.values
  ...
  static final Map<String, String> _walletCountryNames = {
  ...
  static String getWalletCountryName(String name) {
    final key = name.trim();
    return _walletCountryNames[key] ?? key;
  }
