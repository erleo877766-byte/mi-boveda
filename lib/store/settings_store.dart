...
abstract class SettingsStoreBase with Store {
  SettingsStoreBase(
    ...
    if (initialWalletCountry != null) {
      selectedWalletCountry = initialWalletCountry;
    }
    ...
    reaction((_) => selectedWalletCountry, (Country? country) {
      if (country != null) {
        sharedPreferences.setString(PreferencesKey.currentWalletCountry, country.raw);
      }
    });
  ...
  static Future<SettingsStore> load(
    ...
    final savedWalletCountryRaw =
        sharedPreferences.getString(PreferencesKey.currentWalletCountry);
    final currentWalletCountry =
        savedWalletCountryRaw != null ? Country.deserialize(raw: savedWalletCountryRaw) : null;
    ...
    return SettingsStore(
      ...
      initialWalletCountry: currentWalletCountry,
