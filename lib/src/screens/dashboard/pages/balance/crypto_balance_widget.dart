                          ...
                          Row(
                            ...
                            children: [
                              GestureDetector(
                                ...
                                onTap: () => launchUrl(
                                  Uri.parse(
                                      "https://ourdocs.com/cryptos/bitcoin#silent-payments"),
                  ...
                  Padding(
                    ...
                    child: InfoCard(
                      ...
                      hintWidget: GestureDetector(
                        behavior: HitTestBehavior.opaque,
                        onTap: () => launchUrl(
                          Uri.parse("https://ourdocs.com/cryptos/litecoin/#mweb"),
                          mode: LaunchMode.externalApplication,
                        ),
                        child: Text(
                  ...
                  Padding(
                    ...
                    child: InfoCard(
                      ...
                      rightButtonAction: () => launchUrl(
                          Uri.parse("https://ourdocs.com/cryptos/decred/#spv-sync")),
                    ),
                  ),
                ],
                  ...
                  Padding(
                    ...
                    child: InfoCard(
                      ...
                      hintWidget: GestureDetector(
                        behavior: HitTestBehavior.opaque,
                        onTap: () => launchUrl(
                          Uri.parse("https://ourdocs.com/cryptos/bitcoin/#payjoin"),
                          mode: LaunchMode.externalApplication,
                        ),
                        child: Row(
                          children: [
